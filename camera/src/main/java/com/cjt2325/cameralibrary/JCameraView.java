...
//            setStartPreview(mCamera, mHolder);
    ...
    private void startRecord() {
        ...
        //wzteng
        String path = saveVideoPath + "/PlayCamera/PlayVideo/";
        ...
        try {
            ...
            values.put(MediaStore.Video.Media.DATA, saveVideoPath + videoFileName);
            uri = mContext.getContentResolver().insert(MediaStore.Video.Media.EXTERNAL_CONTENT_URI, values);
        } catch (Exception e) {
            e.printStackTrace();
        }
        // 最后通知图库更新
        mContext.sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE,
                Uri.parse("file://" + saveVideoPath + videoFileName)));
