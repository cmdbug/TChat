...
public class ImagePagerActivity extends YWActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.friends_activity_imagepager);
    ...
    private void addGuideView(LinearLayout guideGroup, int startPos, ArrayList<String> imgUrls) {
        if(imgUrls!=null && imgUrls.size()>0){
            ...
            for (int i=0; i<imgUrls.size(); i++){
                ...
                view.setBackgroundResource(R.drawable.friends_selector_guide_bg);
    ...
    private static class ImageAdapter extends PagerAdapter{
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            View view = inflater.inflate(R.layout.friends_item_pager_image, container, false);
            if(view != null){
