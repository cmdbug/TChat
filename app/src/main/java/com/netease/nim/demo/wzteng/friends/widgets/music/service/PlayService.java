package com.netease.nim.demo.wzteng.friends.widgets.music.service;
...
import com.netease.nim.demo.wzteng.friends.widgets.music.receiver.NoisyAudioStreamReceiver;
import com.netease.nim.demo.wzteng.friends.widgets.music.utils.Actions;
import com.netease.nim.demo.wzteng.friends.widgets.music.utils.MusicUtils;
...
//        Notifier.showPause(mPlayingMusic);
    ...
    public void updatePlayingPosition() {
        ...
        mPlayingPosition = position;
        Preferences.saveCurrentSongId(MusicCache.get().getMusicList().get(mPlayingPosition).getId());
    }
