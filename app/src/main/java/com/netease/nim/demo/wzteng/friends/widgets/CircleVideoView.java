package com.netease.nim.demo.wzteng.friends.widgets;
...
import com.netease.nim.demo.wzteng.friends.widgets.videolist.VideoListGlideModule;
import com.netease.nim.demo.wzteng.friends.widgets.videolist.model.VideoLoadMvpView;
import com.netease.nim.demo.wzteng.friends.widgets.videolist.target.VideoLoadTarget;
import com.netease.nim.demo.wzteng.friends.widgets.videolist.target.VideoProgressTarget;
...
public class CircleVideoView extends LinearLayout implements VideoLoadMvpView, ListItem {
    ...
    private void init() {
        inflate(getContext(), R.layout.friends_layout_video, this);
