...
public class LoginActivity extends UI implements OnKeyListener {
    ...
    private Button btnLogin;  // 登录按钮teng
    private Button switchModeBtn;  // 注册/登录切换按钮
...
//        options.logoId = R.drawable.actionbar_white_logo_space;
        options.titleId = R.string.app_name;
...
//        Toast.makeText(this, "权限授权成功", Toast.LENGTH_SHORT).show();
    ...
    private void setupLoginPanel() {
        ivAvatar = findView(R.id.iv_avatar);
...
//            ivAvatar.loadBuddyAvatar(account);
//        }
    ...
    private void setupRegisterPanel() {
        switchModeBtn = findView(R.id.tv_register);
    ...
    private TextWatcher textWatcher = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            updateRightTopBtn(LoginActivity.this, btnLogin, isEnable);
        }
    };
