...
public abstract class QRCodeView extends RelativeLayout implements Camera.PreviewCallback, ProcessDataTask.Delegate {
     ...
     * @param mFramingRect
     */
    public void setScanBoxViewFramingRect(Rect mFramingRect) {
        mScanBoxView.setmFramingRect(mFramingRect);
    }
     ...
     * @return
     */
    public Rect getScanBoxViewFramingRect() {
        return mScanBoxView.getmFramingRect();
    }
     ...
     * @param tipText
     */
    public void setMyTipText(String tipText) {
        mScanBoxView.setMyTipText(tipText);
        postInvalidate();
    }
     ...
     * @param isShow
     */
    public void setShowScanLine(boolean isShow) {
        mScanBoxView.setShowScanLine(isShow);
    }
    //wzteng******************************************
