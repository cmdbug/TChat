...
public class StickerManager {
    ...
    private static final String CATEGORY_TEST = "test";//teng
//    private static final String CATEGORY_QQFACE = "qqface";//teng
    ...
    private void initStickerOrder() {
        ...
        stickerOrder.put(CATEGORY_TEST, 4);//teng
//        stickerOrder.put(CATEGORY_QQFACE, 5);//teng
    }
...
//                CATEGORY_QQFACE.equals(category) ||//teng
                CATEGORY_TEST.equals(category);//teng
    }
...
//        }
        ...
        //teng
        if (isSystemSticker(categoryName)) {
            if (getStickerOrder(categoryName) == 1
                    || getStickerOrder(categoryName) == 2
                    || getStickerOrder(categoryName) == 3) {
                //非gif
                if (!stickerName.contains(".png")) {
                    stickerName += ".png";
                }
            } else if (getStickerOrder(categoryName) == 4) {
                //gif
